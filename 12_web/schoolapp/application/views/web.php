...
<head>
    ...
    <link rel="stylesheet" href="<?=site_url('assets/vendor/simple-line-icons/css/simple-line-icons.css'); ?>">
    <link rel="stylesheet" href="<?=site_url('assets/vendor/device-mockups/device-mockups.min.css'); ?>">

    <!-- Theme CSS -->
    <link href="<?=site_url('assets/css/new-age.min.css'); ?>" rel="stylesheet">
...
<body id="page-top">
                        ...
                        <div class="device-mockup iphone6_plus portrait white">
                            <div class="device">
                                <div class="screen">
                                    ...
                                    <img src="<?=site_url('assets/img/demo-screen-1.jpg'); ?>" class="img-responsive" alt="">
                                </div>
                                <div class="button">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="badges">
                        <a class="badge-link" href="#"><img src="<?=site_url('assets/img/google-play-badge.svg'); ?>" alt=""></a>
                        <a class="badge-link" href="#"><img src="<?=site_url('assets/img/app-store-badge.svg'); ?>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="device-container">
                        <div class="device-mockup iphone6_plus portrait white">
                            <div class="device">
                                <div class="screen">
                                    <!-- Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
                                    <img src="<?=site_url('assets/img/demo-screen-1.jpg'); ?>" class="img-responsive" alt=""> </div>
                                <div class="button">
                                    <!-- You can hook the "home button" to some JavaScript events or just remove it -->
                                </div>
                            </div>
    ...
    <!-- Theme JavaScript -->
    <script src=<?=site_url('assets/js/new-age.min.js');?>"></script>
